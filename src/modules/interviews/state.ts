...
export const OPEN_QUESTIONS: OpenQuestion[] = [
  {
    ...
    text: "Какие сильные стороны этого руководителя ты бы отметил(а)?",
    optional: false,
  },
  {
    id: "growth",
  ...
  },
  {
    ...
    text: "Здесь ты можешь оставить обратную связь в свободной форме (комментарии, пожелания для {subjectName}).\nТакже, если хочешь, можешь подписать своё имя и фамилию, тогда {subjectName} увидит, что это обратная связь от тебя (все остальные твои ответы останутся анонимными).\n\nЕсли ничего не хочешь писать, то напиши «нет» или «-».",
    optional: true,
  },
];
